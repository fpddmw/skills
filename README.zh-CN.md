...
加上 Bluesky Cascades、YouTube Video Search 与 YouTube Comments，共十九个 Skill 已
...
这 19 项不代表 EcoCouncil 已完整迁移。权威迁移源
`main@ac19289b4876d8a90595a0270721ef3f5ee7ced8` 共有 21 个 `source-fetch`
Skill；Regulations.gov attachments 和 USBR project records 两项尚未覆盖，其余原有
17 项也必须完成源语义复核后才能提交 Skills PR。
